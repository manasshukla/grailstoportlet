...
class gsp_sampleGrailsPortlet_sampleDomainlist_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/sampleDomain/list.gsp" }
public Object run() {
Writer out = getOut()
