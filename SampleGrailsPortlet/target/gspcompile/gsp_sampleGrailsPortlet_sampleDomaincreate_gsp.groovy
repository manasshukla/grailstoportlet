...
class gsp_sampleGrailsPortlet_sampleDomaincreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/sampleDomain/create.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('eachError','g',26,['bean':(sampleDomainInstance),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',28,['bean':(sampleDomainInstance)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
